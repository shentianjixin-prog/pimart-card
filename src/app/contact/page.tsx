...
const CONTACT_NOTICE = {
  zh: {
    ...
    items: [
      ...
      "请勿通过邮件或 LINE 发送完整银行卡号、信用卡安全码、登录密码、一次性验证码等敏感信息。",
  ...
  ja: {
    ...
    items: [
      ...
      "カード番号、セキュリティコード、ログインパスワード、ワンタイムコード等の機微情報は送信しないでください。",
  ...
  en: {
    ...
    items: [
      ...
      "Do not send full card numbers, security codes, login passwords, or one-time verification codes by email or LINE.",
