...
const KEY_NOTICES = [
  ...
  {
    title: "咨询信息仅用于处理问题",
    body: "您通过邮件、LINE 或联系页面提交的信息，将用于身份确认、回复、售后举证和安全管理。",
  },
  {
    title: "可依法请求更正或删除",
    ...
    >
      ...
      <LegalArticle id="pv-2" index="02" title="收集的信息">
        ...
        <LegalCallout tone="info">
          为完成配送、售后或客服处理，您可能需要提供收件人、代收人或其他相关人员的信息。提交该等信息前，请确认您已取得相关人员同意，并保证信息真实、准确、必要。
        </LegalCallout>
      </LegalArticle>
      ...
      <LegalArticle id="pv-4" index="04" title="委托与第三方提供">
        <ol className="list-decimal space-y-2">
          <li>为履行合同，本站可能在必要范围内将信息委托给：支付处理商（Stripe）、物流承运商（如 EMS、佐川急便等）、仓储/配送协力方、云主机、数据库、邮件发送、客服联络工具、错误监控和安全防护服务商。</li>
