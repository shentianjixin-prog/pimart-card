  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {hotProducts.map((p) => (
              <div key={p.id} className="relative">
                <span className="absolute -right-1 -top-1 z-10 rounded bg-red-500 px-1.5 py-0.5 text-[10px] font-bold text-white shadow">
                  {T("page_hot_badge")}
                </span>
      ...
      <div className="mb-6">
        ...
        {!showHero && (
          <p className="mt-1 text-sm text-gray-500">{T("page_shipping_desc")}</p>
        )}
      </div>
