...
const ROWS: Row[] = [
  ...
  { id: "tk-japan-delivery", label: "日本国内履行住所", value: `${JAPAN_DELIVERY_CONTACT_ADDRESS}\n※販売業者の所在地ではありません。返品前に ${SUPPORT_EMAIL} へ連絡し、書面で指定された返品先をご利用ください。` },
  {
    id: "tk-phone",
    label: "電話番号",
  ...
  { id: "tk-timing", label: "支払時期", value: "注文確定時に即時決済。予約商品も注文時決済となります。" },
  {
    id: "tk-delivery",
    label: "商品の引渡時期",
    value: "商品は日本の履行拠点へ一括輸入後、日本国内の配送業者より発送します。\n【現物】商品ページ・決済画面の案内に従い、決済確認後 5〜7 営業日を目安に発送\n【予約・取り寄せ】表示の発送/入荷予定は目安。出荷・検品・輸入通関・配送等により遅延する場合があり、実際の発送日をもって確定\n※初回表示の発送予定日から90日経過しても未発送の場合、当該商品の実支払額で返金申請可（予定が「月」のみの場合は当該月末起算）",
  },
  {
    id: "tk-valid",
    label: "申込の有効期限",
