...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        title: "お客様都合",
        body: "お客様都合の返品・交換は原則お受けできません（クーリングオフの一律適用はありません）。未開封BOX・予約・PSA・ランダム/開封系は特殊商品です。ご注文・お支払いをもって商品ページと利用規約に同意したものとみなします。",
      },
      {
        title: "対応可能な場合",
...
const KEY_NOTICES = [
  {
    title: "お客様都合の返品は原則不可",
    body: "未開封BOX・予約・PSA・ランダム/開封系は特殊商品です。クーリングオフの一律適用はありません。",
  },
  {
    title: "受取後7日以内にご連絡",
