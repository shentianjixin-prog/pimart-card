        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-[#6b7280]">
              Global Trading Card Marketplace for sealed boxes, PSA cards, and wholesale supply.
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-[#111827]">Shop</p>
            <div className="mt-3 flex flex-col gap-2 text-sm">
              <Link href="/?category=宝可梦原盒" className="link-muted">Pokémon</Link>
              <Link href="/?q=PSA" className="link-muted">PSA Picks</Link>
              <Link href="/?inStock=1" className="link-muted">Sealed Boxes</Link>
            </div>
          </div>
          <div>
            <p className="text-sm font-semibold text-[#111827]">Support</p>
            <div className="mt-3 flex flex-col gap-2 text-sm">
          ...
          <div>
            <p className="text-sm font-semibold text-[#111827]">Legal</p>
            <div className="mt-3 flex flex-col gap-2 text-sm">
