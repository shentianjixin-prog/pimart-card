...
const dict: Record<string, Record<Lang, string>> = {
  ...
  hero_v2_s2_desc: {
    zh: "甄选多语产品，严控品质，带来最愉快的购物体验。",
    ja: "多言語商品を厳選し、品質にこだわり、心地よいお買い物を。",
    en: "Curated multilingual products, quality first — for a delightful shopping experience.",
  },
  ...
  hero_v2_cta_merch: { zh: "查看周边", ja: "周辺を見る", en: "Shop Merch" },
  ...
  hero_premium_lead: {
    ...
    ja: "ポケモン、ワンピース、多言語の未開封商品を厳選。価格・在庫・発送条件を明確にし、安心できる購入体験を。",
    en: "A considered selection of Pokémon, One Piece, and multilingual sealed products — with clear pricing, live stock, and transparent dispatch terms.",
  },
  hero_quick_label: { zh: "快速选购", ja: "クイックショップ", en: "Quick shop" },
  hero_quick_pokemon: { zh: "宝可梦", ja: "ポケモン", en: "Pokémon" },
  hero_quick_onepiece: { zh: "海贼王", ja: "ワンピース", en: "One Piece" },
  hero_quick_instock: { zh: "现货", ja: "在庫あり", en: "In stock" },
  hero_quick_preorder: { zh: "预售", ja: "予約", en: "Pre-order" },
  hero_fact_label: { zh: "服务标准", ja: "サービス基準", en: "Service standards" },
  hero_fact_auth_value: { zh: "可溯源", ja: "追跡可能", en: "Traceable" },
  hero_fact_auth_label: { zh: "正规采购渠道", ja: "正規仕入れルート", en: "Sourcing channels" },
  hero_fact_ship_value: { zh: "可追踪", ja: "追跡対応", en: "Tracked" },
  hero_fact_ship_label: { zh: "物流邮件通知", ja: "発送通知メール", en: "Dispatch updates" },
  hero_fact_b2b_value: { zh: "B2B", ja: "B2B", en: "B2B" },
  hero_fact_b2b_label: { zh: "批量采购支持", ja: "大口仕入れ対応", en: "Wholesale support" },
  service_bar_label: { zh: "购买保障", ja: "ショッピングサポート", en: "Shop with clarity" },
  service_bar_stock: { zh: "库存状态实时显示", ja: "在庫状況を明確に表示", en: "Live stock status" },
  service_bar_shipping: { zh: "发货周期购前可见", ja: "発送目安を購入前に表示", en: "Dispatch timing upfront" },
  service_bar_support: { zh: "订单与售后人工支持", ja: "注文・アフターサポート", en: "Order & after-sales support" },
  service_bar_shop: { zh: "查看全部商品", ja: "すべての商品", en: "View all products" },
  ...
  trusted_f3_desc: { zh: "商品页明确展示发货周期与预售状态", ja: "発送目安と予約状況を商品ページに明記", en: "Dispatch timing and pre-order status shown before purchase" },
  ...
  auth_err_email_not_configured: { zh: "邮件服务暂未开通，请通过邮箱联系客服重置密码", ja: "メール送信は未設定です。サポートメールへご連絡ください", en: "Email service is not configured. Contact support by email" },
  ...
  contact_desc: { zh: "商品咨询、订单物流、售后与会员账号问题，请通过邮箱联系客服。", ja: "商品・注文・配送・アフター・会員アカウントに関するご相談は、サポートメールへご連絡ください。", en: "For products, orders, shipping, after-sales, and account help, contact us by email." },
