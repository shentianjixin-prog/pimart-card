...
const dict: Record<string, Record<Lang, string>> = {
  ...
  filter_type_sealed:  { zh: "原盒 / 未开封",  ja: "未開封BOX",    en: "Sealed Boxes" },
  filter_type_psa:     { zh: "PSA 评级卡",     ja: "PSA鑑定品",    en: "PSA Graded" },
  filter_type_single:  { zh: "单卡",           ja: "シングル",     en: "Singles" },
  filter_type_merch:   { zh: "周边商品",       ja: "周辺グッズ",   en: "Merchandise" },
